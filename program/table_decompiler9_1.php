...
const NIGHT1 = "night";
if(true){
	index::register(0xC, "ウォルロ地方", null, "平地", DAY, ++$counter, "Angel Falls", DAY1);
	index::register(0xF, "ウォルロ地方", null, "森", ALWAYS, $counter, "Angel Falls", ALWAYS1);
	index::register(0xE, "ウォルロ地方", null, "平地", NIGHT, $counter, "Angel Falls", NIGHT1);
	...
	index::register(0x0, "西セントシュタイン", null, "平地", DAY, ++$counter, "Western Stornway", "upper half");
	index::register(0x2, "西セントシュタイン", null, "平地", NIGHT, $counter, "Western Stornway", "slightly below center");
	index::register(0x3, "西セントシュタイン", null, "森", ALWAYS, $counter, "Western Stornway", "under");
	index::register(0x24, "東セントシュタイン", null, "陸(平地&森)", ALWAYS, ++$counter, "Eastern Stornway", "land");
	index::register(0x25, "東セントシュタイン", null, "海岸", ALWAYS, $counter, "Eastern Stornway", "sandy beach");
	index::register(0x125, "エラフィタ地方", null, "お城側の橋付近", DAY, ++$counter, "Zere", "castle side(day)");
	index::register(0x126, "エラフィタ地方", null, "お城側の橋付近", NIGHT, $counter, "Zere", "castle side(night)");
	...
	index::register(0x7, "エラフィタ地方", null, "毒付近の茂みと毒の辺り", "夜&常時", $counter, "Zere", "Forest near poison (always) and poison (night)");
	index::register(0x8, "ほろびのもり", "滅びの森", "(平地・森)", DAY, ++$counter, "Doomingale Forest", "?");
	index::register(0xa, "ほろびのもり", "滅びの森", "(平地・森 夜)", NIGHT, $counter, "Doomingale Forest", "?");
	index::register(0xb, "ほろびのもり", "滅びの森", "(荒地)", ALWAYS, $counter, "Doomingale Forest", "?");
	...
	index::register(0x10, "東ベクセリア地方", null, "平地", DAY, ++$counter);
	index::register(0x12, "東ベクセリア地方", null, "平地", NIGHT, $counter);
	index::register(0x13, "東ベクセリア地方", null, "森・ススキ", ALWAYS, $counter);
	index::register(0x14, "西ベクセリア地方", null, "平地・森", DAY, $counter);
	index::register(0x15, "西ベクセリア地方", null, "平地・森", NIGHT, ++$counter);
	index::register(0x16, "西ベクセリア地方", null, "ススキ", ALWAYS, $counter);
	index::register(0x17, "西ベクセリア地方", null, "海岸", ALWAYS, $counter);
	index::register(0x1e, "ふういんのほこら", "封印のほこら", "", DUNGEON, ++$counter);
	index::register(0x28, "アユルダーマとう", "アユルダーマ島", "平地", DAY, ++$counter);
	index::register(0x29, "アユルダーマとう", "アユルダーマ島", "平地", NIGHT, $counter);
	index::register(0x2a, "アユルダーマとう", "アユルダーマ島", "森", ALWAYS, $counter);
	index::register(0x2b, "アユルダーマとう", "アユルダーマ島", "荒地", ALWAYS, $counter);
	...
	index::register(0x2d, "アユルダーマとう(ツォのはま)", "アユルダーマ島(ツォの浜)", "平地・森", DAY, ++$counter);
	index::register(0x2e, "アユルダーマとう(ツォのはま)", "アユルダーマ島(ツォの浜)", "平地・森", NIGHT, $counter);
	...
	index::register(0x3b, "ベレンのきしべ", "ベレンの岸辺", "平地", DAY, ++$counter);
	index::register(0x3c, "ベレンのきしべ", "ベレンの岸辺", "平地", NIGHT, $counter);
	index::register(0x3d, "ベレンのきしべ", "ベレンの岸辺", "森", ALWAYS, $counter);
	index::register(0x3e, "ベレンのきしべ", "ベレンの岸辺", "砂浜", ALWAYS, $counter);
	index::register(0x3f, "カラコタ地方", null, "平地", DAY, ++$counter);
	index::register(0x40, "カラコタ地方", null, "平地", NIGHT, $counter);
	index::register(0x41, "カラコタ地方", null, "森", ALWAYS, $counter);
	index::register(0x42, "ピタリへいげん", "ビタリ平原", "平地", DAY, ++$counter);
	index::register(0x43, "ピタリへいげん", "ビタリ平原", "平地", NIGHT, $counter);
	index::register(0x44, "ピタリへいげん", "ビタリ平原", "ピタリ山付近(森・荒地)", ALWAYS, $counter);
	...
	index::register(0x51, "サンマロウ地方 (サンマロウ側)", null, "平地", DAY, ++$counter);
	index::register(0x52, "サンマロウ地方 (サンマロウ側)", null, "平地", NIGHT, $counter);
	index::register(0x53, "サンマロウ地方 (サンマロウ側)", null, "洞窟付近(森)", ALWAYS, $counter);
	index::register(0x54, "サンマロウ地方 (サンマロウ側)", null, "荒地(プラチナ鉱石の所)", ALWAYS, $counter);
	...
	index::register(0x5a, "グビアナ砂漠", null, "平地", DAY, ++$counter);
	index::register(0x5b, "グビアナ砂漠", null, "平地", NIGHT, $counter);
	index::register(0x5c, "グビアナ砂漠", null, "窪地", ALWAYS, $counter);
	index::register(0x62, "ヤハーンしっち", "ヤハーン湿地", "平地・森", DAY, ++$counter);
	index::register(0x63, "ヤハーンしっち", "ヤハーン湿地", "平地・森", NIGHT, $counter);
	index::register(0x64, "ヤハーンしっち", "ヤハーン湿地", "湿地", ALWAYS, $counter);
	index::register(0x65, "カルバド大そうげん", "カルバド大草原", "(全域)", DAY, ++$counter);
	index::register(0x66, "カルバド大そうげん", "カルバド大草原", "", NIGHT, $counter);
	index::register(0x67, "ダダマルダ山", null, "(全域)", ALWAYS, ++$counter);
	index::register(0x68, "カズチィチィ山", null, "平地・森", ALWAYS, ++$counter);
	index::register(0x139, "カズチィチィ山", null, "主にばくだん岩がスポーンする地点(荒地)", ALWAYS, $counter);
	...
	index::register(0x74, "あめのしま", "雨の島", "全域", DAY, ++$counter);
	index::register(0x75, "あめのしま", "雨の島", "全域", NIGHT, $counter);
	index::register(0x70, "アシュバル地方", null, "平地", DAY, ++$counter);
	index::register(0x71, "アシュバル地方", null, "平地", NIGHT, $counter);
	index::register(0x72, "アシュバル地方", null, "森", ALWAYS, $counter);
	index::register(0x73, "アシュバル地方", null, "海岸", ALWAYS, $counter);
	index::register(0x78, "エルマニオンかいがん", "エルマニオン海岸", "(全域)", ALWAYS, ++$counter);
	index::register(0x76, "エルマニオンせつげん", "エルマニオン雪原", "(全域)", DAY, ++$counter);
	index::register(0x77, "エルマニオンせつげん", "エルマニオン雪原", "(全域)", NIGHT, $counter);
	...
	index::register(0x7f, "エルシオン地下こうしゃ", "エルシオン地下校舎", "B2F", DUNGEON, ++$counter);
	index::register(0x8a, "東ナザム地方", null, "平地", DAY, ++$counter);
	index::register(0x8b, "東ナザム地方", null, "平地", NIGHT, $counter);
	index::register(0x8c, "東ナザム地方", null, "森・海岸", ALWAYS, $counter);
	index::register(0x8d, "西ナザム地方", null, "平地・森", DAY, $counter);
	index::register(0x8e, "西ナザム地方", null, "平地・森", NIGHT, $counter);
	index::register(0x8f, "西ナザム地方", null, "荒地", ALWAYS, $counter);
	...
	index::register(0x94, "竜のもん", "竜の門", "平地・森", DAY, ++$counter);
	index::register(0x95, "竜のもん", "竜の門", "平地・森", NIGHT, $counter);
	index::register(0x13a, "竜のもん", "竜の門", "荒地", ALWAYS, $counter);
	index::register(0x96, "竜のしっぽ地方", null, "平地・森", DAY, ++$counter);
	index::register(0x97, "竜のしっぽ地方", null, "平地・森", NIGHT, $counter);
	index::register(0x98, "竜のしっぽ地方", null, "荒地", ALWAYS, $counter);
	index::register(0x9c, "竜のつばさ地方", null, "平地・森", DAY, ++$counter);
	index::register(0x9d, "竜のつばさ地方", null, "平地・森", NIGHT, $counter);
	index::register(0x9e, "竜のつばさ地方", null, "海岸", ALWAYS, $counter);
	index::register(0x9f, "竜のつばさ地方", null, "荒地", ALWAYS, $counter);
	index::register(0x99, "竜のしっぽ地方 2", null, "平地・森", DAY, $counter);
	index::register(0x9a, "竜のしっぽ地方 2", null, "平地・森", NIGHT, $counter);
	index::register(0x9b, "竜のしっぽ地方 2", null, "荒地", ALWAYS, $counter);
	index::register(0xa0, "竜のあきと地方", null, "(全域)", DAY, ++$counter);
	index::register(0xa1, "竜のあきと地方", null, "(全域)", NIGHT, $counter);
	...
	index::register(0x80, "ジャーホジ地方", null, "", DAY, $counter);
	index::register(0x81, "ジャーホジ地方", null, "", NIGHT, $counter);
	index::register(0x82, "オンゴリのガケ", null, "", NIGHT, ++$counter);
	index::register(0x83, "オンゴリのガケ", null, "", DAY, ++$counter);
	index::register(0x61, "ルビアナ地下すいどう", null, "B2F", DAY, ++$counter);
	index::register(0x11B, "アユルダーマとう", null, " (天の箱舟)", ALWAYS, ++$counter);
	index::register(0x12F, "西ベクセリア地方 (小島)", null, "", DAY, ++$counter);
	index::register(0x130, "西ベクセリア地方 (小島)", null, "", NIGHT, $counter);
	index::register(0x11A, "東セントシュタイン", null, "(天の箱舟) (全域)", NIGHT, ++$counter);
	index::register(0x137, "サンマロウ地方 (小島)", null, "(全域)", ALWAYS, ++$counter);
	index::register(0x11C, "ピタリ海岸 (高台)", null, "(全域)", ALWAYS, ++$counter);
	index::register(0x45, "ピタリ海岸 (平地)", null, "", DAY, ++$counter);
	index::register(0x46, "ピタリ海岸 (平地)", null, "", NIGHT, $counter);
	index::register(0x47, "ピタリ海岸 (森)", null, "", ALWAYS, ++$counter);
	index::register(0x48, "ピタリ海岸 (海岸)", null, "", ALWAYS, $counter);
	index::register(0x133, "あめのしま (小島)", null, "", DAY, ++$counter);
	index::register(0x134, "あめのしま (小島)", null, "", NIGHT, $counter);
	index::register(0x12A, "グビアナ砂漠 北西の小島", null, "", DAY, ++$counter);
	index::register(0x12B, "グビアナ砂漠 北西の小島", null, "", NIGHT, $counter);
	index::register(0x12C, "グビアナ砂漠 北東の小島", null, "(全域)", ALWAYS, $counter);
	index::register(0x11D, "グビアナ砂漠(高台)", null, "(全域)", ALWAYS, ++$counter);
	index::register(0x11E, "アシュバル地方(高台)", null, "", DAY, ++$counter);
	index::register(0x138, "アシュバル地方(高台)", null, "", NIGHT, $counter);
	...
	index::register(0x7A, "アイスバリー海岸 (平地・森)", null, "", DAY, ++$counter);
	index::register(0x7B, "アイスバリー海岸 (平地・森)", null, "", NIGHT, $counter);
	index::register(0x7C, "アイスバリー海岸 (海岸)", null, "", DAY, $counter);
	index::register(0x7D, "アイスバリー海岸 (海岸)", null, "", NIGHT, $counter);
	index::register(0x135, "南ナザム地方 (小島)", null, "", DAY, $counter);
	index::register(0x136, "南ナザム地方 (小島)", null, "", NIGHT, $counter);
	index::register(0x123, "南ナザム地方 (高台)", null, "(全域)", ALWAYS, ++$counter);
	index::register(0x124, "竜のしっぽ地方 (高台)", null, "(全域)", ALWAYS, ++$counter);
	index::register(0xAB, "竜のくび地方(平地・草原・森)", null, "", DAY, ++$counter);
	index::register(0xAC, "竜のくび地方(平地・草原・森)", null, "", NIGHT, $counter);
...
$result_3g = [];
$result_test = [];
foreach($table0 as $tableId => $item){
...
//	}
	...
	foreach($item as $info){
		$tmp1 = $info << 0x11 & 0xFFFFFFFF;
		$totalrand = $totalrand + ($tmp1 >> 0x1d);

		$tmp = $info << 0x14 & 0xFFFFFFFF; //14      モンスターidかもしれない 要調査 0209cef4
		$id = $tmp >> 0x14;


		$tmp10 = $info << 0xe & 0xFFFFFFFF;
		$min = $tmp10 >> 0x1d; //最小数を足す(1)
//最小数
